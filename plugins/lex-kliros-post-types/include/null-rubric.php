...
<h2>Список произведений вообще без рубрики!</h2>
<?php if ($res) : ?>
   <ol>
      <?php foreach ($res as $value) : ?>
         <li><a href="<?php echo get_permalink($value); ?>"><strong><?php echo esc_html(get_the_title($value)); ?></strong><i class="user-text"><?php echo ' ';
