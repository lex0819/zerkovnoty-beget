...
<section>
	<div class="wrap">
		<div class="main">
			<div class="content">
				<?php if (have_posts()) : ?>
					<h2 class="title-h2">Сборники на сайте:</h2>
					<p class="count-item">Найдено сборников: <span><?php echo $wp_query->found_posts; ?><span></p>
					<?php lex_kliros_posts_pagination($wp_query->max_num_pages); ?>
					<ol class="list-item">
						<?php while (have_posts()) : the_post();
							get_template_part('lex', 'list_collect');
						endwhile; ?>
					</ol>
				<?php else : ?>
